...
return [
    ...
    'customers' => [
        'title' => 'ข้อมูลลูกค้า',
        'description' => 'จัดการข้อมูลการติดต่อของลูกค้าสำหรับทีมรับออเดอร์',
        'contact_label' => 'ข้อมูลติดต่อ',
        'contact_person' => 'ผู้ติดต่อ',
        'notes_label' => 'หมายเหตุ',
        'not_provided' => 'ไม่ได้ระบุ',
        'empty' => 'ยังไม่มีการลงทะเบียนลูกค้า',
        'demo_notice' => 'กำลังแสดงข้อมูลลูกค้าแบบตัวอย่าง เมื่อคุณบันทึกลูกค้าจริง ข้อมูลนี้จะถูกแทนที่',
        'demo_actions_disabled' => 'ไม่สามารถเพิ่มหรือแก้ไขได้ในโหมดตัวอย่าง',
        'buttons' => [
            'create' => 'เพิ่มลูกค้า',
            'edit' => 'แก้ไข',
            'delete' => 'ลบ',
            ...
            'update' => 'อัปเดตลูกค้า',
            'cancel' => 'ยกเลิก',
            'back' => 'กลับไปหน้ารายชื่อลูกค้า',
        ],
        'confirm_delete' => 'ต้องการลบลูกค้ารายนี้หรือไม่?',
        'form' => [
            'create_title' => 'เพิ่มลูกค้า',
            'edit_title' => 'แก้ไขลูกค้า',
            'fields' => [
                'name' => 'ชื่อลูกค้า',
                'contact' => 'หมายเลขโทรศัพท์',
                'contact_person' => 'ผู้ติดต่อ',
                'notes' => 'หมายเหตุ',
            ],
            'placeholders' => [
                'notes' => 'ระบุความต้องการพิเศษ ข้อมูลการจัดส่ง เป็นต้น',
            ],
        ],
        'notes' => [
        ...
        'flash' => [
            'created' => 'บันทึกลูกค้าเรียบร้อยแล้ว',
            'create_failed' => 'ไม่สามารถบันทึกลูกค้าได้ กรุณาลองใหม่อีกครั้ง',
            'updated' => 'อัปเดตข้อมูลลูกค้าเรียบร้อยแล้ว',
            'update_failed' => 'ไม่สามารถอัปเดตข้อมูลลูกค้าได้ กรุณาลองใหม่อีกครั้ง',
            'deleted' => 'ลบข้อมูลลูกค้าเรียบร้อยแล้ว',
            'delete_failed' => 'ไม่สามารถลบข้อมูลลูกค้าได้ กรุณาลองใหม่อีกครั้ง',
        ],
    ],
    'admin_users' => [
