...
return [
    ...
    'admin' => [
        'users' => [
            'title' => 'จัดการผู้ใช้',
            'description' => 'จัดการบัญชีผู้ดูแลและพนักงานที่ใช้งานระบบ Mobile Order.',
            'create_button' => 'สร้างใหม่',
            'create_title' => 'เพิ่มผู้ใช้',
            'create_description' => 'ลงทะเบียนบัญชีผู้ใช้ใหม่สำหรับผู้ดูแลหรือพนักงาน ฟิลด์ที่จำเป็นจะแสดงสัญลักษณ์ *.',
            'validation_error_heading' => 'กรุณาตรวจสอบข้อมูลต่อไปนี้',
            'table' => [
                'name' => 'ชื่อ-นามสกุล',
                'email' => 'อีเมล / Login ID',
                'phone' => 'โทรศัพท์มือถือ',
                'department' => 'แผนก',
                'authority' => 'สิทธิ์การใช้งาน',
            ],
            'roles' => [
                'admin' => 'ผู้ดูแลระบบ',
                'manager' => 'ผู้จัดการ',
            ...
            'role_descriptions' => [
                'admin' => 'เข้าถึงและตั้งค่าระบบได้ทุกส่วน.',
                'manager' => 'จัดการคำสั่งซื้อและผู้ใช้ภายในแผนกของตน.',
                'staff' => 'ดูและแก้ไขคำสั่งซื้อที่ได้รับมอบหมาย.',
            ],
            'form' => [
                'name' => [
                    'label' => 'ชื่อ-นามสกุล',
                ...
                'phone' => [
                    ...
                    'placeholder' => 'เช่น 080-1234-5678',
                ],
                'department' => [
                    'label' => 'แผนก',
                ...
                'notify_new_orders' => [
                    'label' => 'รับการแจ้งเตือนคำสั่งซื้อใหม่',
                    'help' => 'ส่งอีเมลเมื่อมีการลงทะเบียนคำสั่งซื้อใหม่.',
                ],
                'require_password_change' => [
                    'label' => 'บังคับให้เปลี่ยนรหัสผ่านเมื่อเข้าสู่ระบบครั้งแรก',
                    'help' => 'ให้ผู้ใช้ตั้งรหัสผ่านของตนเองหลังจากเข้าสู่ระบบครั้งแรก.',
                ],
                'password' => [
            ...
            'flash' => [
                'created' => 'บันทึกข้อมูลผู้ใช้แล้ว (mock).',
            ],
        ],
    ],
];
